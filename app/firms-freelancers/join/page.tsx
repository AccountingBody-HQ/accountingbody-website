    ...
    <main className="min-h-screen bg-[#faf9f7]">
      <section className="bg-[#0f2444] text-white py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl font-bold mb-4">List Your Practice</h1>
          <p className="text-blue-200 text-lg">Join our accounting directory and get discovered by clients across the UK.</p>
        </div>
      </section>
